...
if PY3: #XXX: get types from .objtypes ?
    ...
    if (sys.hexversion >= 0x30200f0):
        try:
            ...
            from _dummy_thread import RLock as RLockType
    else:
        try:
            from threading import _RLock as RLockType
        except ImportError:
            from dummy_threading import _RLock as RLockType
   ...
   #FileType = IOBase
    ...
    try:
        ...
        from dummy_thread import LockType
    try:
        from threading import _RLock as RLockType
    except ImportError:
        from dummy_threading import _RLock as RLockType
